...
//import com.java.tutorial.project.exception.TimetableSolverException;
//import lombok.Data;
...
//    public ScoreAnalysis<HardSoftScore> analyze(@RequestBody Timetable problem, @RequestParam(name = "fetchPolicy", required = false) ScoreAnalysisFetchPolicy fetchPolicy) {
...
//        }
//
//        public Job(Timetable timetable, Throwable exception) {
