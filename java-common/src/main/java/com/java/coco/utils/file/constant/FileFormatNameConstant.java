...
public class FileFormatNameConstant {
    ...
    private static final List<String> FILE_CHARACTER_LIST = List.of(" ", "-", "@", "「", "」", "《", "》", "【", "】", "[", "]", "『"
            , "』", "〖", "〗", "▌", "(", ")", "（", "）", "。", "“", "”", "，", "~", "#", "!", "！", "+", "=", "⊙", "❤");


    private static final List<String> FILE_SPECIAL_SYMBOL_LIST = List.of(".net", ".org", ".com", ".cc", ".hd", ".org", ".xyz", "www.");


    static final List<String> FILTER_STRING_LIST = List.of("soushu555", "soushu2021",
            "2048社区-big2048", "thzu", "2048社区", "big2048", "bt-btt", "ai高清2k修复", "bbs.yzkof", "uuc82", "1024核工厂",
            "fun2048", "thzutm", "原创", "重磅泄露", "最新", "更新", "nyap2p", "bt-btt", "soav",
            "uncensored", "leaked", "每日更新", "每日", "799dvd", "606dvd", "136dvd", "136dvd", "909dvd", "132dvd"
            , "fulibus", "91视频", "91自拍", "国产自拍", "kiki", "魔性论坛", "www.mox.life", "2048论坛bbs2048", "sexflexvideo",
            "yonitale", "bbs2048", "", "onlyfans", "eapk", "guochan2048", "8899xx",
