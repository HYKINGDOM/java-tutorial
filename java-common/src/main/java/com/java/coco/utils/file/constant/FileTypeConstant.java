...
public class FileTypeConstant {
    ...
    public static final String[] VIDEO_EXTENSION =
        {"mp4", "swf", "flv", "mp3", "wav", "wma", "wmv", "mid", "avi", "mpg", "asf", "rm", "rmvb", "mkv", "mov", "ts",
            "mpeg", "mts", "3gp", "m4a", "m4b", "m4p"};
    ...
    /**
     * "图片": ["jpeg", "jpg", "tiff", "gif", "bmp", "png", "bpg", "svg", "heif", "psd"], "文档": ["oxps", "epub", "pages",
     * "docx", "doc", "fdf", "ods", "odt", "pwi", "xsn", "xps", "dotx", "docm", "dox", "rvg", "rtf", "rtfd", "wpd",
     * "xls", "xlsx", "ppt", "pptx", "csv", ",pdf"], "压缩文件": ["a", "ar", "cpio", "iso", "tar", "gz", "rz", "7z", "dmg",
     * "rar", "xar", "zip"], "影音": ["aac", "aa", "aac", "dvf", "m4a", "m4b", "m4p", "mp3", "msv", "ogg", "oga", "raw",
     * "vox", "wav", "wma"], "文本": ["txt", "in", "out"], "编程": ["py", "html5", "html", "htm", "xhtml", "c", "cpp",
     * "java", "css"], "可执行程序": ["exe"],
     */
