...
public class RanDomUtils {
    ...
    /**
     * 随机字符串大小写和各种字符带空格 如下 l4Vq
     * Um<o-eXz_+jj<_)(gn(ez88GsBQE$4DXGtfh7C[{q:4:%rgFKiKt]e8uf"z!Xnqg[-l=8MS8]Cd6w_VuypMhGioKv=!;~>'
     *
     * @param strLength
     * @return
     */
    ...
    /**
     * 随机各种语言特殊字符 𡜂𢫶🅣鑋膱𡠃槬𣢚𧑫칻𧱮𦷪𨊨쀝𡩗𧈍럦𩓔⒴㊛䯛㟠㤉𡒨𝆐줎𣑋叿싄㩃𠢝摃皊⋢𩜌ᚁ𣘲𠁖Ｚ䔌Ϧ𤸰냢𣎸𩸘⪲𦯦忉찼豢𣚹𪅰𩁓𦯑ᇐ봲௸躚核戙𧆾쮙𑄻𢓏𪈟𪯯꾕⺎
     *
     * @param strLength
     * @return
     */
    ...
    /**
     * 随机字符串大小写和各种字符带空格 如下 i-9U#+[wy;KYWdbV`}6F` 7Z_s!(x1dT(x
     * mH{*@>q,*1^AA5B^A,YC#2thuE"(5ZDMV(bSe1xQD](q<ifEtBu83/F2*FeQ(+R8A
     *
     * @param strLength
     * @return
     */
