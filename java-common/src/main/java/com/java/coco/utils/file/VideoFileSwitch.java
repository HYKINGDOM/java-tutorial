...
public class VideoFileSwitch {
    ...
    public static final String[] VIDEO_CLASSIFICATION_THREE =
        {"ABP", "ABS", "ABW", "ADN", "AEG", "AFS", "BBI", "BDA", "BEB", "BGN", "BMW", "CHN", "CHO", "CRS", "CWP", "DCV",
            "DDD", "DDH", "DFE", "DGL", "DIC", "DRG", "EHM", "EKW", "EMP", "FAD", "FC2", "FIR", "GVG", "GVH", "HAR",
            "HEY", "HHH", "HMN", "HND", "HPP", "HRV", "IMG", "ION", "IPX", "IPZ", "JAC", "JNT", "JUC", "JUL", "JUP",
            "JUX", "JUY", "KUF", "LAF", "LLR", "MDS", "MFC", "MIX", "MKD", "MKZ", "MMB", "MUM", "NDV", "NTK", "NTR",
            "OAE", "OHO", "OVG", "OYC", "PGD", "PHD", "PMX", "PPT", "RAW", "RBD", "RCT", "RED", "RHJ", "RKI", "RVG",
            "S2M", "SCR", "SFV", "SGA", "SHH", "SHS", "SHX", "SIS", "SKY", "SMD", "SOE", "TAP", "TCD", "TEK", "THZ",
            "TRE", "TRP", "UMD", "URE", "VEC", "VGD", "XND", "XRW", "YRZ", "YSN", "ZEX"};
    public static final String[] VIDEO_CLASSIFICATION_FOUR =
        {"SDSI", "2016", "AKDL", "AMBS", "ANCI", "APNS", "ATFB", "ATGO", "ATID", "AVOP", "BBAN", "BDSR", "BOBB", "CAWD",
            "CEMD", "CESD", "CHAA", "CHRV", "CJOB", "CJOD", "CLUB", "CSCT", "CWDV", "CZBD", "DASD", "DCRY", "DKDN",
            "DKSB", "DMOW", "DOCP", "DOKS", "DPHN", "DPMI", "DPMX", "DVAJ", "EBOD", "EYAN", "FCDC", "FFFD", "FGAN",
            "FINH", "FNEO", "FSET", "GANA", "GENT", "GONE", "HARU", "HDKA", "HHKL", "HJMO", "HMGL", "HMJM", "HNDB",
            "HNDS", "HNTV", "HODV", "HPOW", "HTMS", "HUNT", "HXAD", "HZGD", "IDBD", "IENE", "IENF", "IPIT", "IPSD",
            "IPVR", "IPXB", "JUFD", "JUFE", "KAWD", "KFNE", "KIRE", "KMRE", "KNMB", "KRMV", "KRND", "KTDS", "KUSE",
            "LCBD", "LLDV", "LULU", "LUXU", "MAAN", "MDTM", "MDYD", "MEYD", "MIAA", "MIAD", "MIAE", "MIDD", "MIDE",
            "MIFD", "MIGD", "MIMK", "MIRD", "MISA", "MISM", "MIUM", "MIZD", "MKBD", "MKDV", "MKMP", "MMGH", "MMND",
            "MRSS", "MSFH", "MUDR", "MUGF", "MVSD", "MXGS", "NACR", "NACX", "NASH", "NGOD", "NHDT", "NNPJ", "NSPS",
            "NTTR", "OFJE", "OKAX", "ONSD", "ONSG", "OREC", "OTIM", "PKPD", "PPBD", "PPPD", "PRED", "QIAN", "RCTD",
            "REAL", "REBD", "REZD", "RHTS", "SDAB", "SDDE", "SDJS", "SDMM", "SDMU", "SDNM", "SDTH", "SERO", "SHKD",
            "SIMM", "SIRO", "SIVR", "SKMJ", "SKSK", "SMBD", "SMDV", "SNIS", "SORA", "SPOR", "SQTE", "SSHN", "SSIS",
            "SSKP", "SSNI", "SSPD", "STAR", "SUKE", "SW61", "TBTB", "TIKB", "TSDS", "UMSO", "URKK", "URVK", "VEMA",
            "VENU", "VENX", "VICD", "VNDS", "VRTM", "WAAA", "WANZ", "XRLE", "XVSR", "YMDD", "ZIZG", "ZMAR", "ZMEN"};
    public static final String[] VIDEO_CLASSIFICATION_FIVE =
        {"AKAHH", "ATKDB", "CARIB", "CTNOZ", "CWPBD", "CZ015", "DANDY", "DFSSD", "DRGBD", "DVDES", "FSDSS", "H4610",
            "HEYZO", "HOISW", "HUNTA", "HUNTB", "LAFBD", "MXSPS", "N0464", "N0476", "N1222", "NHDTA", "NHDTB", "OFJEA",
            "S2MBD", "SDJS1", "SKYHD", "SSNI7", "STARS", "SVDVD", "SWEET", "TOKYO", "XVSR6"};
    /**
     * 特殊字符
     */
     ...
     * 特殊字段
     */
    public static final String[] CONSTANT_FILE_NAME_ARRAY =
        {"SOUSHU555.NET", "SOUSHU555.COM", "SOUSHU555.ORG", "SOUSHU2021.COM", "2048社区-BIG2048.COM", "THZU.CC",
            ...
            "8899XX.XYZ", "jav20s8.com", "guochan2048.com"};
