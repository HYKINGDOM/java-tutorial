package com.java.coco.scs.manager.reflace;
...
public class JavaFunction {
    ...
    public void test_java_class() {
        ...
        try {
            ...
            //获取对象
            Class<? extends Hero> pClass3 = Hero.class;
    ...
    public void test_contractor_java_class() {
        ...
        try {
            ...
            Constructor<Hero> con = clazz.getConstructor(null);
    ...
    public void test_java_reflex_main_method() {
        try {
            //1、获取HeroPlus对象的字节码
            Class<HeroPlus> clazz = HeroPlus.class;
