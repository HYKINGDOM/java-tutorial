...
public class MinIOUtil {
    ...
    public void createMinioClient() {
        try {
            ...
            log.error("MinIO服务器异常：{}", ExceptionUtil.getExceptionMessage(e));
        }
    }
    ...
    public static String uploadFile(String bucketName, String objectName, String fileName, boolean needUrl)
        ...
        if (needUrl) {
            return fileHost + SEPARATOR + bucketName + SEPARATOR + objectName;
        }
        return "";
    }
    ...
    public static void removeFiles(String bucketName, List<String> keys) {
        ...
        keys.forEach(s -> {
            ...
            try {
                ...
                log.error("批量删除失败！error:{}", ExceptionUtil.getExceptionMessage(e));
            }
        });
    }
    ...
    public static String getPresignedObjectUrl(String bucketName, String objectName, Integer expires) throws Exception {
        GetPresignedObjectUrlArgs args =
            GetPresignedObjectUrlArgs.builder().expiry(expires).bucket(bucketName).object(objectName).build();
