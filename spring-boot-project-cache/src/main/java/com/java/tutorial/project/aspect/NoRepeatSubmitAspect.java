...
import com.java.tutorial.project.annotation.RepeatSubmit;
...
public class NoRepeatSubmitAspect {
     ...
     * 定义切点
     */
    @Pointcut("@annotation(com.java.tutorial.project.annotation.RepeatSubmit)")
    ...
    public Object around(ProceedingJoinPoint joinPoint) {
        ...
        String token = request.getHeader("IdempotentConstant");
         ...
         *
         */
        String redisKey = getMethodSign(method, joinPoint.getArgs());
