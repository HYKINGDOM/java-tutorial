...
public class VelocityUtils {
    ...
    public static VelocityContext prepareContext(GenTable genTable) {
        ...
        velocityContext.put("CapitalUnderScoreClassName",
            StringUtils.upperCase(StringUtils.toUnderScoreCase(genTable.getClassName())));//大写的类名下划线：SYS_USER
    ...
    public static void setSubVelocityContext(VelocityContext context, GenTable genTable) {
        ...
        context.put("CapitalUnderScoreSubTableFkClassName",
            StringUtils.upperCase(StringUtils.toUnderScoreCase(subTableFkClassName)));//带下划线的字段大写
        context.put("subTableFkclassName", StringUtils.uncapitalize(subTableFkClassName));
        context.put("subClassName", subClassName);
        context.put("CapitalUnderScoreSubClassName",
            StringUtils.upperCase(StringUtils.toUnderScoreCase(subClassName)));//大写的子类类名下划线：SYS_USER
    ...
    public static String getFileName(String template, GenTable genTable) {
        ...
        switch (template) {
            case "vm/java/domain.java.vm" -> fileName = StrUtil.format("{}/domain/{}.java", javaPath, className);
            case "vm/java/sub-domain.java.vm" ->
                fileName = StrUtil.format("{}/domain/{}.java", javaPath, genTable.getSubTable().getClassName());
            case "vm/java/vo.java.vm" -> fileName = StrUtil.format("{}/domain/vo/{}Vo.java", javaPath, className);
            case "vm/java/vo-import.java.vm" ->
                fileName = StrUtil.format("{}/domain/vo/{}ImportVo.java", javaPath, className);
            case "vm/java/bo.java.vm" -> fileName = StrUtil.format("{}/domain/bo/{}Bo.java", javaPath, className);
            case "vm/java/mapper.java.vm" -> fileName = StrUtil.format("{}/mapper/{}Mapper.java", javaPath, className);
            ...
            case "vm/java/listener.java.vm" ->
                fileName = StrUtil.format("{}/listener/{}ImportListener.java", javaPath, className);
            case "vm/xml/mapper.xml.vm" -> fileName = StrUtil.format("{}/{}Mapper.xml", mybatisPath, className);
            case "vm/xml/sub-mapper.xml.vm" ->
                fileName = StrUtil.format("{}/{}Mapper.xml", mybatisPath, genTable.getSubTable().getClassName());
            ...
            case "vm/api/element.ts.types.vm" ->
                fileName = StrUtil.format("{}/api/{}/{}/types.ts", vuePath, moduleName, businessName);
            case "vm/api/antdesign.ts.index.vm" ->
                fileName = StrUtil.format("{}/api/{}/{}/index.ts", vbenPath, moduleName, businessName);
            case "vm/api/antdesign.ts.model.vm" ->
                fileName = StrUtil.format("{}/api/{}/{}/model.ts", vbenPath, moduleName, businessName);
            ...
            case "vm/vue/antdesign.ts.index.vue.vm" ->
                fileName = StrUtil.format("{}/views/{}/{}/index.vue", vbenPath, moduleName, businessName);
            case "vm/vue/antdesign.ts.data.vm" -> fileName =
                StrUtil.format("{}/views/{}/{}/{}.data.ts", vbenPath, moduleName, businessName, businessName);
            case "vm/vue/antdesign.ts.modal.vue.vm" -> fileName =
                StrUtil.format("{}/views/{}/{}/{}Modal.vue", vbenPath, moduleName, businessName, BusinessName);
    ...
    public static String getParentMenuId(JSONObject paramsObj) {
        if (ObjectUtil.isNotEmpty(paramsObj) && paramsObj.containsKey(
            GenConstants.PARENT_MENU_ID) && StringUtils.isNotEmpty(paramsObj.getString(GenConstants.PARENT_MENU_ID))) {
