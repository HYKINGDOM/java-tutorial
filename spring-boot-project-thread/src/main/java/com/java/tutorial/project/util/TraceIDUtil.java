...
public class TraceIDUtil {
    ...
    public static String getTraceId() {
        ...
        if (StrUtil.isAllEmpty(traceId, ttlTraceId)) {
            traceId = createTraceId();
            ttlTraceId = traceId;
            setTraceIdToMdc(traceId);
            setTraceIdToTtl(ttlTraceId);
        } else if (StrUtil.isNotEmpty(traceId) && StrUtil.isEmpty(ttlTraceId)) {
            ttlTraceId = traceId;
            setTraceIdToTtl(traceId);
        } else if (StrUtil.isEmpty(traceId) && StrUtil.isNotEmpty(ttlTraceId)) {
            traceId = ttlTraceId;
