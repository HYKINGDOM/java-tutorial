package com.java.util.javautil.utils.sign;
...
public final class Base64 {
    ...
    static private final int TW_ENTY_FOUR_BIT_GROUP = 24;
    ...
    public static String encode(byte[] binaryData) {
        ...
        int fewerThan24bits = lengthDataBits % TW_ENTY_FOUR_BIT_GROUP;
        int numberTriplets = lengthDataBits / TW_ENTY_FOUR_BIT_GROUP;
