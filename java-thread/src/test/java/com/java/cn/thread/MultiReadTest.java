...
public class MultiReadTest {
    ...
    public static void main(String[] args) {
        ...
        final String OUT_FILE_NAME = "E:\\\\文件\\\\Desktop\\\\考勤最新数据源\\\\1月_软通考勤 - 副本.xlsx\"";
        final String keywords = "软通";
        ...
        try {
            ...
            for (int i = 0; i < DOWN_THREAD_NUM; i++) {
                ...
                if (i == DOWN_THREAD_NUM - 1) {
                    ...
                    new ReadThread(i * numPerThred, (i + 1) * numPerThred + left, outArr[i], keywords,
                        doneSignal).start();
                } else {
