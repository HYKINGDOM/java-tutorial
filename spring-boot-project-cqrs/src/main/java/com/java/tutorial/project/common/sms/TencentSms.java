//package com.java.tutorial.project.common.sms;
//
...
//	 * @return
//	 */
//	public String sendMessage(String tempId, String[] phones, String[] params) {
//		try {
//			SmsClient client = this.getSendSmsClient();
//			SendSmsRequest req = this.getSendSmsRequest();
...
//	}
//
//	private SmsClient getSendSmsClient() {
//		/*
//		 * 必要步骤： 实例化一个认证对象，入参需要传入腾讯云账户密钥对 secretId 和 secretKey
//		 * 本示例采用从环境变量读取的方式，需要预先在环境变量中设置这两个值
//		 * 您也可以直接在代码中写入密钥对，但需谨防泄露，不要将代码复制、上传或者分享给他人 CAM
...
//		 * 可以进一步设置请求参数 您可以直接查询 SDK 源码确定接口有哪些属性可以设置
...
//		 * 您可以通过官网接口文档或跳转到 request
//		 * 对象的定义处查看请求参数的定义 基本类型的设置: 帮助链接：
//		 * 短信控制台：https://console.cloud.tencent.com/smsv2 sms
